                  ...
                  <Section title="Lease (optional)">
                    ...
                    {form.unitId && (
                      <>
                        ...
                        <label className="flex cursor-pointer items-start gap-2.5 rounded-lg border border-zinc-800 bg-zinc-900/60 p-3 transition hover:border-zinc-700">
                          <input
                            type="checkbox"
  ...
  return (
    <div className="space-y-4 text-center">
      ...
      {onboardingUrl ? (
        <div className="rounded-xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 via-zinc-950 to-blue-500/10 p-4 shadow-[0_0_28px_rgba(16,185,129,0.10)] text-left">
          ...
          <a
            ...
            className="mt-3 block truncate rounded-md border border-emerald-500/30 bg-zinc-950 px-2.5 py-1.5 font-mono text-[11px] text-emerald-200 hover:underline"
            title={onboardingUrl}
          >
            {onboardingUrl}
          </a>
      ...
      <button
        type="button"
        onClick={onClose}
        className="mt-2 rounded-md border border-zinc-700 bg-zinc-950 px-4 py-2 text-xs font-semibold text-zinc-200 hover:bg-zinc-900"
      >
        Done
      </button>
    </div>
